...
plt.plot(q, st.beta.pdf(q, a, b), 'k-', label='事後確率')
plt.plot(q, st.beta.pdf(q, a0, b0), 'k:', label='事前確率')
plt.xlim(0, 1)
plt.ylim(0, 7)
...
for index in range(2):
    ...
    ax2[index].plot(q, st.beta.pdf(q, a0_i, b0_i), color='k',
                    ...
                    label='事前確率 Beta({0:<3.1f}, {1:<3.1f})'.format(a0_i, b0_i))
